...
(
    ...
    `backup_url`       varchar(256)          DEFAULT NULL COMMENT 'URL of the standby DB server',
    `agent_status`     varchar(256)          DEFAULT NULL COMMENT 'Agent running status, NORMAL, STOPPED, SWITCHED...',
    `task_ids`         text                  DEFAULT NULL COMMENT 'Task IDs being collected by DbSync, is the ID of stream_source table',
    `db_dump_index`    bigint(20)            DEFAULT NULL COMMENT 'BinLog index currently collected',
    `dump_position`    text                  DEFAULT NULL COMMENT 'BinLog position currently collected, will be saved as JSON string',
