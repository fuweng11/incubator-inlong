...
/**
 * Inlong cluster info for ZK
 */
@Data
@ToString(callSuper = true)
@EqualsAndHashCode(callSuper = true)
@JsonTypeDefine(value = ClusterType.ZOOKEEPER)
@ApiModel("Inlong cluster info for ZK")
public class ZkClusterInfo extends ClusterInfo {
    ...
    @Override
    public ZkClusterRequest genRequest() {
        return CommonBeanUtils.copyProperties(this, ZkClusterRequest::new);
    }
