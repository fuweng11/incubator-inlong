...
public class InnerHiveSinkRequest extends SinkRequest {
    ...
    @ApiModelProperty("zone id")
    private Integer zoneId;

    @ApiModelProperty("zone name")
    ...
    @ApiModelProperty(value = "artition creation policy", notes = "like:ARRIVED-data arrival,COMPLETED-data completion,"
    ...
    @ApiModelProperty("dara separtor")
    ...
    private List<StorageHiveField> hiveFieldList;

    // @ApiModelProperty("other extended information")
    // private List<StorageExtDTO> extList;

    @Data
    @ApiModel("the most basic field information saved in the update interface and save interface")
    public static class StorageHiveField {
