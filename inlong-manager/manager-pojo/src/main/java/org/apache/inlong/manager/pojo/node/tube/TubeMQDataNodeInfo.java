...
/**
 * TubeMQ data node info
 */
@Data
@ToString(callSuper = true)
@EqualsAndHashCode(callSuper = true)
@JsonTypeDefine(value = DataNodeType.TUBEMQ)
@ApiModel("TubeMQ data node info")
public class TubeMQDataNodeInfo extends DataNodeInfo {
    ...
    public DataNodeRequest genRequest() {
        return CommonBeanUtils.copyProperties(this, TubeMQDataNodeRequest::new);
    }
}
