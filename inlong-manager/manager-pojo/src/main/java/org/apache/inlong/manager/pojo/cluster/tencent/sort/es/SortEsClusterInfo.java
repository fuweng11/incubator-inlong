...
package org.apache.inlong.manager.pojo.cluster.tencent.sort.es;
...
/**
 * Inlong sort cluster for es task
 */
@Data
@ToString(callSuper = true)
@EqualsAndHashCode(callSuper = true)
@JsonTypeDefine(value = ClusterType.SORT_ES)
@ApiModel("Inlong sort cluster for es task")
public class SortEsClusterInfo extends BaseSortClusterInfo {
    ...
    @Override
    public SortEsClusterRequest genRequest() {
