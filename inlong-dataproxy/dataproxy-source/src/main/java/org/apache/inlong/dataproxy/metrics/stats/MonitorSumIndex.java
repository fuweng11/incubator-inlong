...
/**
 * Monitor summary index
 *
 *
 * The summary index statistics received or sent by DataProxy nodes, and output to file.
 */
public class MonitorSumIndex extends AbsStatsDaemon {

    private static final Logger LOGGER = LoggerFactory.getLogger(MonitorSumIndex.class);
    ...
    public MonitorSumIndex(String compName, String statsName, long intervalMill, int maxCnt) {
