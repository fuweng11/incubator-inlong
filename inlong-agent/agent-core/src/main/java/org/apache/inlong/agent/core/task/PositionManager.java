 ...
 */
public class PositionManager extends AbstractDaemon implements ITaskPositionManager {

    private static final Logger LOGGER = LoggerFactory.getLogger(PositionManager.class);
    private static volatile ITaskPositionManager positionManager = null;
    ...
    public static ITaskPositionManager getInstance(DbAgentManager agentManager) {
        if (positionManager == null) {
            synchronized (PositionManager.class) {
                if (positionManager == null) {
                    positionManager = agentManager.getJobManager();
                }
            }
        }
        return positionManager;
