...
public class DbColumnChangeManager {

    protected final Logger logger = LogManager.getLogger(this.getClass());
    protected final Logger alterFieldLogger = LogManager.getLogger("jobAlterFieldMonitor");

    private static final DbColumnChangeManager FIELD_MANAGER = new DbColumnChangeManager();
    ...
    public static DbColumnChangeManager getInstance() {
    ...
    public void addAlterFieldString(String bid, Integer taskId, String alterQueryString) {
        if (running) {
            if (StringUtils.isEmpty(bid) || ObjectUtils.isEmpty(taskId) || StringUtils.isEmpty(alterQueryString)) {
            ...
            builder.append("bid=").append(bid).append("|")
                    ...
                    .append("alterQueryString=").append(alterQueryString).append("|");
            ...
            alterFieldLogger.info(builder.toString());
        }
    }
