 ...
 */
public class TaskPositionManager extends AbstractDaemon implements ITaskPositionManager {

    private static final Logger LOGGER = LoggerFactory.getLogger(TaskPositionManager.class);
    private static volatile ITaskPositionManager taskPositionManager = null;
     ...
     */
    public static ITaskPositionManager getInstance(AgentManager agentManager) {
    ...
    public static ITaskPositionManager getInstance(DbAgentManager agentManager) {
        if (taskPositionManager == null) {
            synchronized (TaskPositionManager.class) {
                if (taskPositionManager == null) {
                    taskPositionManager = agentManager.getJobManager();
                }
            }
        }
        return taskPositionManager;
     ...
     */
    public static ITaskPositionManager getInstance() {
        if (taskPositionManager == null) {
